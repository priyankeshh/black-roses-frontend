export default {
  ...
  eventSignup: {
    ...
    invitedBy: 'Wie heeft je uitgenodigd voor dit evenement?',
    invitedByPlaceholder: 'Voer de naam in van de persoon die je heeft uitgenodigd',
  ...
  admin: {
    ...
    registrationStats: 'Registratie Statistieken',
    statusBreakdown: 'Status Verdeling',
    preferences: 'Voorkeuren',
    topInvitedBy: 'Top Verwijzingen',
    noInvitedByData: 'Geen verwijzingsgegevens beschikbaar',
    filterRegistrations: 'Filter Registraties',
    clearFilters: 'Filters Wissen',
    searchNameEmail: 'Zoeken op naam of e-mail',
    allStatuses: 'Alle Statussen',
    allGearTypes: 'Alle Uitrustingstypes',
  ...
  albums: {
    ...
    noEvent: 'Geen Gerelateerd Evenement',
    ...
    videoTitle: 'Video Titel (Optioneel)',
